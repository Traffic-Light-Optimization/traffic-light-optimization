...
file_locations = [
    ...
    ("beyers", "./nets/beyers/beyers.net.xml", "./nets/beyers/beyers_rand.rou.xml", "./nets/beyers/beyers.add.xml"),
    ("beyers24hour", "./nets/beyers/beyers.net.xml", "./nets/beyers/beyers.rou.xml", "./nets/beyers/beyers.add.xml"),
