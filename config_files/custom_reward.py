...
def my_reward_fn(traffic_signal):
    ...
    # Implement reward for cars that never stopped at the robot divided by the number of cars that passes through the robot.
    # Implement Diff queue length reward
    return reward