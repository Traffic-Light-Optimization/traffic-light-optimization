...
seeds = ["89393","7356","12345", "2134", "1204234", "123456", "1234567", "12345678", "123456789", "1234567890", "3244235", "389472", "389749", "4392", "3478947", "231245", '3', '3353', "344554", "32452325"]
# Remove results
...
for reward_option in rewards:
    ...
    for seed in seeds:
        ...
        sim_path = f"./results/rewards/{map}/sim-{map}-{mdl}-{observation}-{reward_option}_conn1_ep{i}"
