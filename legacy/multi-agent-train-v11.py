...
max_green = 60
simRepeats = [18, 35] # Number of episodes
parallelEnv = 14
...
yellow_time = 3 # min yellow time
 # This is the total number of steps in the environment that the agent will take for training. It’s the overall budget of steps that the agent can interact with the environment.
maps = ["cologne1", "cologne3"]
mdl = 'PPO' # Set to DQN for DQN model
observations = ["ideal", "camera", "gps"]
seeds = ['89393','7356'] # or 'random' '8493'  1234 99393
...
if __name__ == "__main__":
    ...
    for map, seed, simrepeat in zip(maps, seeds, simRepeats):
      net_route_files = get_file_locations(map) # Select a map
      totalTimesteps = numSeconds*simrepeat*parallelEnv
