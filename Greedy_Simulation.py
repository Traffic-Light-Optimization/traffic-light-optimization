...
map = "cologne8" #NB, don't forget to change this variable if you change the network, see fixed_control_configs/action_lane_relationships for map names
action_lanes = Map_Junction_Action_Lanes[map]

env = sumo_rl.env(
    net_file="Multi_agent/nets/cologne8/cologne8.net.xml",
    route_file="Multi_agent/nets/cologne8/cologne8.rou.xml",
    use_gui=True,
    num_seconds=3600,
    delta_time=5,
